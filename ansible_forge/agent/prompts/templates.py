...
2. If you are unsure how to fix it, use the `web_search` tool to look up the error message \
...
3. Fix the issue by calling the appropriate tools.
4. Re-run the failed action after fixing.
5. Only report to the user AFTER you have attempted the fix.
