...
hidden_imports = [
    ...
    "ansible_forge.api.endpoints.checkpoints",
    ...
    "ansible_forge.agent.prompts.topics",
    "ansible_forge.knowledge.learning_store",
    "ansible_forge.knowledge.packs",
    "ansible_forge.knowledge.workspace_memory",
    "ansible_forge.plugins.hooks",
    "ansible_forge.plugins.loader",
    "ansible_forge.tools.knowledge_tool",
    ...
    "ansible_forge.tools.file_reader",
    ...
    "ansible_forge.tools.local_exec",
