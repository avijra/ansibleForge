...
const quickActions: QuickAction[] = [
  {
    ...
    prompt: "Deploy nginx on admin@192.168.1.100",
  ...
  },
  {
    ...
    prompt: "Check the status of host admin@192.168.1.100",
    color: "text-zinc-400 bg-zinc-800/50 ring-zinc-700/40",
  },
  {
    icon: FileCode2,
    ...
    prompt: "Create a playbook that installs Docker on Ubuntu servers",
    color: "text-zinc-400 bg-zinc-800/50 ring-zinc-700/40",
  },
  {
    icon: Network,
    ...
    prompt: "Set up an inventory for my web and database servers",
    color: "text-zinc-400 bg-zinc-800/50 ring-zinc-700/40",
  },
  {
    icon: Shield,
    ...
    prompt: "Harden the security of my Ubuntu 22.04 server at admin@192.168.1.100",
    color: "text-zinc-400 bg-zinc-800/50 ring-zinc-700/40",
  },
];
